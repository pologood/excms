 ...
 * @version v1.0 <br/>
 */
public interface IScheduleJobService extends IBaseService<ScheduleJobEO> {
    // 任务类型
     ...
     * @return
     */
    ScheduleJobEO getScheduleJobByClazzAndJson(String clazz, String json);
