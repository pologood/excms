...
/**
 * @author chen.chao
 * @version 2017-09-21 16:06
 */
@Entity
@Table(name="MONITOR_WORDS_EASYERR_CONF")
public class WordsEasyerrEO extends ABaseEntity implements Serializable {
    ...
    /**推送时间*/
   /* @Column(name = "PUSH_DATE", updatable = false)
