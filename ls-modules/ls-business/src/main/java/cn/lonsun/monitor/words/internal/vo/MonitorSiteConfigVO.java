...
public class MonitorSiteConfigVO {
	...
	public MonitorSiteConfigVO(){

	}

	public MonitorSiteConfigVO(Long siteId, String siteName, Integer isRegistered, String registeredCode, Date registeredTime) {
		this.siteId = siteId;
