package cn.lonsun.lottery.internal.utils;
...
public class LotteryUtil {
    public class ContinuousList {
        ...
        public ContinuousList(double minElement, double maxElement,Long  typeId){
     ...
     * @param list 为奖品的概率
     */
    public LotteryUtil(List<Double> list,List<Long>idList){
        ...
        for(int i=0;i<list.size();i++){
            ...
            maxElement = maxElement + list.get(i);
            continuousList = new ContinuousList(minElement, maxElement,idList.get(i));
