 ...
 */
@Repository("htmlCollectTaskDao")
public class HtmlCollectTaskDao extends MockDao<HtmlCollectTaskEO> implements IHtmlCollectTaskDao {
    ...
    public Pagination getPageEOs(CollectPageVO vo) {
        ...
        StringBuilder hql = new StringBuilder("from HtmlCollectTaskEO where 1=1 and siteId = ?");
    ...
    public void deleteEOs(Long[] ids) {
        ...
        param.put("ids", ids);
        this.executeUpdateByJpql("delete from HtmlCollectTaskEO where id in (:ids)", param);
    }
}
