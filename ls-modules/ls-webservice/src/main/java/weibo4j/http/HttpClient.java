...
public class HttpClient implements java.io.Serializable {
	...
	static Logger log = LoggerFactory.getLogger(HttpClient.class.getName());
	...
	public Response httpRequest(HttpMethod method, Boolean WithTokenHeader, String token)
		...
		try {
			...
			response.setResponseAsString(StreamUtils.copyToString(method.getResponseBodyAsStream(), Charset.defaultCharset()));
