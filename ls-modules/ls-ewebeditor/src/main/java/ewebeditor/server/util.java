...
public class util {
    ...
    public boolean RegExpTest(String str, String s_Pattern) {
    ...
    public String getSiteRootRealPath() {
        ...
        /**if(s_RealPath.contains(":")){
         String realPath = getClass().getClassLoader().getResource("/").getPath();
         int start = realPath.startsWith("/")?1:0;
         s_RealPath = realPath.substring(start, realPath.indexOf(":")) +
         s_RealPath.substring(s_RealPath.indexOf(":"), s_RealPath.length());
         }
         **/
    ...
    public String inHTML(String st) {
        StringBuffer buf = new StringBuffer();
    ...
    public String GetHideInputHtml(String s_Name, String s_Value) {
        return "<input type=\"hidden\" name=\"" + s_Name + "\" id=\"" + s_Name + "\" value=\"" + inHTML(s_Value) + "\">";
    }

    public String GetSafeStr(String s) {
        if (RegExpTest(s, "[\\<\\>\\\"]+")) {
            return "";
        } else {
            return s;
    ...
    public String GetSafeUrl(String s) {
        if (RegExpTest(s, "[\\<\\>\\\"\\'\\;\\(\\)\\?\\%\\&\\r\\n\\t]+")) {
            return "";
        } else {
            return s;
