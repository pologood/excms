...
UE.I18N['zh-cn'] = {
    ...
    'insertunorderedlist': {'circle': '○ 大圆圈', 'disc': '● 小黑点', 'square': '■ 小方块 ', 'dash': '— 破折号', 'dot': ' 。 小圆圈'},
    'paragraph': {'p': '段落', 'h1': '一级标题', 'h2': '二级标题', 'h3': '三级标题', 'h4': '四级标题', 'h5': '五级标题', 'h6': '六级标题'},
    'fontfamily': {
        'songti': '宋体',
        'kaiti': '楷体',
        'heiti': '黑体',
    ...
    'customstyle': {'tc': '标题居中', 'tl': '标题居左', 'im': '强调', 'hi': '明显强调'},
    'autoupload': {
    ...
    'snapScreen_plugin': {'browserMsg': "仅支持IE浏览器！", 'callBackErrorMsg': "服务器返回数据有误，请检查配置项之后重试。", 'uploadErrorMsg': "截图上传失败，请检查服务器端环境! "},
    'insertcode': {
        'as3': 'ActionScript 3',
        'bash': 'Bash/Shell',
        'cpp': 'C/C++',
    ...
    'background': {
        ...
        }, 'noUploadImage': "当前未上传过任何图片！", 'toggleSelect': "单击可切换选中状态\n原图尺寸: "
    },
    'insertimage': {
        'static': {
    ...
    'attachment': {
        'static': {'lang_tab_upload': '上传附件', 'lang_tab_online': '在线附件', 'lang_start_upload': "开始上传", 'lang_drop_remind': "可以将文件拖到这里，单次最多可选100个文件"},
    ...
    'webapp': {'tip1': "本功能由百度APP提供，如看到此页面，请各位站长首先申请百度APPKey!", 'tip2': "申请完成之后请至ueditor.config.js中配置获得的appkey! ", 'applyFor': "点此申请", 'anthorApi': "百度API"},
    'template': {
        'static': {'lang_template_bkcolor': '背景颜色', 'lang_template_clear': '保留原有内容', 'lang_template_select': '选择模板'},
        'blank': "空白文档",
        'blog': "博客文章",
        'resume': "个人简历",
        'richText': "图文混排",
    ...
    'scrawl': {
        ...
        }, 'noScarwl': "尚未作画，白纸一张~", 'scrawlUpLoading': "涂鸦上传中,别急哦~", 'continueBtn': "继续", 'imageError': "糟糕，图片读取失败了！", 'backgroundUploading': '背景图片上传中,别急哦~'
    },
    'music': {
        'static': {'lang_input_tips': "输入歌手/歌曲/专辑，搜索您感兴趣的音乐！", 'J_searchBtn': {value: '搜索歌曲'}},
    ...
    'anchor': {'static': {'lang_input_anchorName': '锚点名字：'}},
    'charts': {
        'static': {
    ...
    'gmap': {'static': {'lang_input_address': '地址', 'lang_input_search': '搜索', 'address': {value: "北京"}}, searchError: '无法定位到该地址!'},
    'help': {
        'static': {
    ...
    'link': {
        'static': {'lang_input_text': '文本内容：', 'lang_input_url': '链接地址：', 'lang_input_title': '标题：', 'lang_input_target': '是否在新窗口打开：'},
        'validLink': '只支持选中一个链接时生效',
        'httpPrompt': '您输入的超链接中不包含http等协议名称，默认将为您添加http://前缀'
    },
    'map': {'static': {lang_city: "城市", lang_address: "地址", city: {value: "北京"}, lang_search: "搜索", lang_dynamicmap: "插入动态地图"}, cityMsg: "请选择城市", errorMsg: "抱歉，找不到该位置！"},
    'searchreplace': {
        'static': {
            lang_tab_search: "查找",
            lang_tab_replace: "替换",
        ...
        }, getEnd: "已经搜索到文章末尾！", getStart: "已经搜索到文章头部", countMsg: "总共替换了{#count}处！"
    },
    'snapscreen': {
        'static': {
    ...
    'spechars': {'static': {}, tsfh: "特殊字符", lmsz: "罗马字符", szfh: "数学字符", rwfh: "日文字符", xlzm: "希腊字母", ewzm: "俄文字符", pyzm: "拼音字母", yyyb: "英语音标", zyzf: "其他"},
    'edittable': {
        'static': {
            ...
            'lang_color': '颜色:'
        }, captionName: '表格名称', titleName: '标题', cellsName: '内容', errorMsg: '有合并单元格，不可排序'
    },
    'edittip': {'static': {lang_delRow: '删除整行', lang_delCol: '删除整列'}},
    'edittd': {'static': {lang_tdBkColor: '背景颜色:'}},
    'formula': {'static': {}},
    'wordimage': {
        'static': {
            lang_resave: "转存步骤",
        ...
        }, 'fileType': "图片", 'flashError': "FLASH初始化失败，请检查FLASH插件是否正确安装！", 'netError': "网络连接错误，请重试！", 'copySuccess': "图片地址已经复制！", 'flashI18n': {}
    },
...
!function () {
    ...
    function stringInputToObject(color) {
        ...
        return (match = matchers.rgb.exec(color)) ? {r: match[1], g: match[2], b: match[3]} : (match = matchers.rgba.exec(color)) ? {
            ...
            l: match[3],
            a: match[4]
        } : (match = matchers.hsv.exec(color)) ? {h: match[1], s: match[2], v: match[3]} : (match = matchers.hsva.exec(color)) ? {
            h: match[1],
            s: match[2],
            v: match[3],
            a: match[4]
    ...
    tinycolor.prototype = {
        isDark: function () {
            ...
            return {r: mathRound(100 * bound01(this._r, 255)) + "%", g: mathRound(100 * bound01(this._g, 255)) + "%", b: mathRound(100 * bound01(this._b, 255)) + "%", a: this._a}
        ...
        var w2 = 1 - w1, rgba = {r: rgb2.r * w1 + rgb1.r * w2, g: rgb2.g * w1 + rgb1.g * w2, b: rgb2.b * w1 + rgb1.b * w2, a: rgb2.a * p + rgb1.a * (1 - p)};
...
function meitu_upload() {
    if (sso.check_userlogin()) {
        ...
        xiuxiu.onBeforeUpload = function (data, id) {
            ...
            xiuxiu.setUploadArgs({'return': "xiuxiu", 'remote_type': 'wechatUploadimg', 'no_thumb': 1, 'MIAOCMS[Auth][User]': $.cookie('MIAOCMS[Auth][User]')}, id);
            return true;
        };
...
function edit_image(url) {
    if (sso.check_userlogin()) {
        ...
        xiuxiu.onBeforeUpload = function (data, id) {
            ...
            xiuxiu.setUploadArgs({'return': "xiuxiu", 'url': url, 'remote_type': 'wechatUploadimg', 'no_thumb': 1, 'MIAOCMS[Auth][User]': $.cookie('MIAOCMS[Auth][User]')}, id);
            return true;
        };
...
(function ($) {
    var pluginName = 'slider', initAllSelector = '[data-role=slider], .slider', paramKeys = ['InitValue', 'Accuracy'];
    $[pluginName] = function (element, options) {
        if (!element) {
            return $()[pluginName]({initAll: true});
        }
        var defaults = {initValue: 0, accuracy: 1};
        var plugin = this;
        plugin.settings = {};
        var $element = $(element);
...
UE.plugins["open135"] = function () {
    ...
    var utils = baidu.editor.utils, Popup = baidu.editor.ui.Popup, Stateful = baidu.editor.ui.Stateful, editorui = baidu.editor.ui, uiUtils = baidu.editor.ui.uiUtils, UIBase = baidu.editor.ui.UIBase;
    ...
    me.addListener('ready', function (editor) {
        ...
        if ($(container).find('.edui-editor-sidebar').size() > 0) {
            $(container).find('.edui-editor-mainbar').css({'width': (width - style_width - 2) + 'px', 'border-left': '1px solid #ddd', 'margin-left': style_width + 'px'});
            $(container).find('.edui-editor-sidebar').css({'position': 'relative', 'width': style_width + 'px', 'float': 'left', 'box-sizing': 'border-box'});
            ...
            $(container).parent().css({'position': 'relative', 'padding-left': style_width + 'px', 'box-sizing': 'border-box'});
            container.style.width = (width - style_width) + "px";
        }
        $('<div></div>').load(me.options.style_url, function () {
            var html = $(this).html();
            var obj_id = 'edui' + me.ui.id + '-styles', obj = $('<div id="' + obj_id + '" style="position:absolute;width:' + style_width + 'px;left:0;top:0;">' + html + '</div>');
            if ($(container).find('.edui-editor-sidebar').size() > 0) {
            ...
            if ($('#editor-styles:hidden', obj).size() > 0) {
                ...
                $('.editor-template-list', obj).mixItUp({
                    layout: {display: 'block'}, selectors: {filter: '#style-categories .filter'}, callbacks: {
            ...
            $('.colorPicker', obj).colorPicker({
                customBG: '#FFF', size: 2, appenTo: 'body', mode: 'hsv-h', init: function (elm, colors) {
...
$(document).on('click', function (event) {
    ...
    if (object && ($(object).parents('#color-plan').size() > 0 || $(object).parents('.cp-app').size() > 0)) {
    }
    else {
        hideColorPlan();
    }
...
if (typeof(window.showSuccessMessage) == 'undefined') {
    window.showSuccessMessage = function (text) {
        if (current_editor) {
            current_editor.fireEvent('showmessage', {'id': 'success-msg', 'content': text, 'type': 'success', 'timeout': 4000});
        }
        else {
            alert(text);
        }
...
if (typeof(window.showErrorMessage) == 'undefined') {
    window.showErrorMessage = function (text) {
        if (current_editor) {
            current_editor.fireEvent('showmessage', {'id': 'error-msg', 'content': text, 'type': 'error', 'timeout': 4000});
        }
        else {
            alert(text);
        }
...
if (typeof(window.ajaxAction) == 'undefined') {
    window.ajaxAction = function (url, postdata, form, callback_func_name, moreags) {
        ...
        $.ajax({
            type: 'post', url: url, data: postdata, complete: function (XMLHttpRequest, textStatus) {
                if (form) {
                    $(':submit', form).each(function () {
...
!function (a, b) {
    ...
    function d(a, b, c) {
        ...
        return e.RGB = {r: a.r, g: a.g, b: a.b}, e.rgb = {
            r: b.r,
            g: b.g,
            b: b.b
        }, e.alpha = c, e.equivalentGrey = Math.round(d.r * a.r + d.g * a.g + d.b * a.b), e.rgbaMixBlack = i(b, {r: 0, g: 0, b: 0}, c, 1), e.rgbaMixWhite = i(b, {
            r: 1,
            g: 1,
            b: 1
    ...
    function e(a, b) {
        var c, e, k, o = b || n, p = u, q = m.options, r = l, s = o.RND, t = "", v = "", w = {hsl: "hsv", cmyk: "cmy", rgb: a}, x = s.rgb;
        if ("alpha" !== a) {
        ...
        return z = i(G, {r: 0, g: 0, b: 0}, H, 1), z[I] = h(z, !0), o.rgbaMixBlack = z, A = i(G, {
            r: 1,
            g: 1,
            b: 1
    ...
    }, p = {r: .298954, g: .586434, b: .114612}, q = {r: .2126, g: .7152, b: .0722}, r = a.Colors = function (a) {
        this.colors = {RND: {}}, this.options = {color: "rgba(204, 82, 37, 0.8)", XYZMatrix: o, grey: p, luminance: q, valueRanges: l}, s(this, a || {})
    }, s = function (a, d) {
        var e, f, g = a.options;
        t(a);
    ...
    var u = {
        txt2color: function (a) {
            ...
            return {r: Math.round(255 * [1, 1 - d, 0, 0, d, 1][c]), g: Math.round(255 * [d, 1, 1, 1 - d, 0, 0][c]), b: Math.round(255 * [0, 0, d, 1, 1, 1 - d][c])}
        }, rgb2hsv: function (a) {
            ...
            return {r: [d, h, g, g, i, d][j], g: [i, d, d, h, g, g][j], b: [g, g, i, d, d, h][j]}
        }, hsv2hsl: function (a) {
            var b = (2 - a.s) * a.v, c = a.s * a.v;
            return c = a.s ? 1 > b ? b ? c / b : 0 : c / (2 - b) : 0, {h: a.h, s: a.v || c ? c : n && n.hsl && n.hsl.s || 0, l: b / 2}
            ...
            return {r: [e, l, f, f, k, e][m], g: [k, e, e, l, f, f][m], b: [f, f, k, e, e, l][m]}
        }, rgb2cmy: function (a) {
            return {c: 1 - a.r, m: 1 - a.g, y: 1 - a.b}
        }, cmy2cmyk: function (a) {
            var b = Math.min(Math.min(a.c, a.m), a.y), c = 1 - b || 1e-20;
            return {c: (a.c - b) / c, m: (a.m - b) / c, y: (a.y - b) / c, k: b}
        }, cmyk2cmy: function (a) {
            var b = a.k;
            return {c: a.c * (1 - b) + b, m: a.m * (1 - b) + b, y: a.y * (1 - b) + b}
        }, cmy2rgb: function (a) {
            ...
            return {X: (f > j ? f : (d - i) / k) * b.X, Y: (g > j ? g : (c - i) / k) * b.Y, Z: (h > j ? h : (e - i) / k) * b.Z}
    ...
    a.ColorPicker = {_html: b, _cssFunc: c, _cssMain: d, _horizontalPng: e, _verticalPng: f, _patchesPng: g, _iconsPng: h, _bgsPng: i, _blankPng: j}
}(window), function (a, b) {
    "use strict";
    function c(a, c) {
        var e, j = "", k = "";
        ...
        for (var m in e)bb[m] !== b && o({target: e[m], data: bb[m]});
    ...
    function q(a) {
        ...
        return C(cb.panel, d, a), C(cb.slds, d, a), a = a.split("-"), bb.mode = {type: a[0], x: b[c].x, y: b[c].y, z: a[1]}
    }

    function r() {
        var a = /\s+(?:hue-)*(?:dark|light)/g, b = "className";
    ...
    function w() {
        ...
        var c, d, e, f, g = bb, h = g.mode, i = g.scale, l = g.CSSPrefix, m = ab, n = cb, o = n.styles, p = n.textNodes, q = S, r = K, s = Z, t = $, u = 0, v = 0, x = m[h.type][h.x], z = Math.round(255 * x / (4 === i ? 2 : i)), B = m[h.type][h.y], C = 1 - B, D = Math.round(255 * C / i), E = 1 - m[h.type][h.z], F = Math.round(255 * E / i), G = [x, B], H = "rgb" === h.type, M = "h" === h.z, N = "hsl" === h.type, O = N && "s" === h.z, P = I === j, Q = I === k;
    ...
    function D(b) {
        ...
        return {left: c.left + (f.pageXOffset || g.scrollLeft) - i, top: c.top + (f.pageYOffset || g.scrollTop) - h}
    }
    ...
    function F(a, b, c) {
        F.cache = F.cache || {
                _get: function (a, b, c, d) {
                    for (var e = F.cache[b] || [], f = e.length; f--;)if (a === e[f].obj && "" + c == "" + e[f].func)return c = e[f].func, d || (e[f] = e[f].obj = e[f].func = null, e.splice(f, 1)), c
                }, _set: function (a, b, c) {
                    var d = F.cache[b] = F.cache[b] || [];
                    return F.cache._get(a, b, c, !0) ? !0 : void d.push({func: c, obj: a})
                }
    ...
    function H(c, d) {
        ...
        if (d === b) {
            if (a.getSelection) {
                c.focus();
                var f = a.getSelection().getRangeAt(0), g = f.cloneRange();
                g.selectNodeContents(c), g.setEnd(f.endContainer, f.endOffset), e = {end: g.toString().length, range: f.toString().length}
            } else {
                c.focus();
                var f = document.selection.createRange(), g = document.body.createTextRange();
                g.moveToElementText(c), g.setEndPoint("EndToEnd", f), e = {end: g.text.length, range: f.text.length}
            }
    ...
    var I, J, K, L, M, N, O = a.ColorPicker, P = !O, Q = document.createStyleSheet !== b && document.getElementById || !!a.MSInputMethodContext, R = "undefined" != (document.body ? typeof document.body.style.opacity : "undefined"), S = {}, T = {
        w: "White",
        b: "Black",
        c: "Custom"
    ...
    a.ColorPicker = hb, hb.addEvent = F, hb.removeEvent = G, hb.getOrigin = D, hb.limitValue = z, hb.changeClass = C, hb.prototype.setColor = function (a, b, c, e) {
        ...
        var a = this.nodes.colorPicker, b = function (a) {
...
(function ($, window) {
    $.fn.extend({
        colorPicker: function (config) {
            var renderCallback = function (colors, mode) {
                var options = this, $input = $(options.input), $patch = $(options.patch), RGB = colors.RND.rgb, HSL = colors.RND.hsl, AHEX = options.isIE8 ? (colors.alpha < 0.16 ? '0' : '') +
                (Math.round(colors.alpha * 100)).toString(16).toUpperCase() + colors.HEX : '', RGBInnerText = RGB.r + ', ' + RGB.g + ', ' + RGB.b, RGBAText = 'rgba(' + RGBInnerText + ', ' + colors.alpha + ')', isAlpha = colors.alpha !== 1 && !options.isIE8, colorMode = $input.data('colorMode');
                $patch.css({
                ...
                var options = this, $input = $(options.input), colorPicker = colorPickers.current;
                ...
                else if (action == 'saveAsBackground') {
                }
                else if (action === 'toMemery') {
                    var memos = colorPicker.nodes.memos, $memo, backgroundColor = '', opacity = 0, cookieTXT = [];
                ...
                $(elm)[onOff]('focus.colorPicker', function (e) {
                    ...
                    $colorPicker.css({'position': 'absolute', 'z-index': 10000, 'left': left + options.margin.left, 'top': top + $input.outerHeight(true) + options.margin.top});
                    if (!multiple) {
                        options.input = elm;
                        options.patch = elm;
                        if (elm.value == "") {
                ...
                if (!colorPickers.evt || off) {
                    ...
                    $(window)[onOff]('mousedown.colorPicker', function (e) {
                        var colorPicker = colorPickers.current, $colorPicker = $(colorPicker ? colorPicker.nodes.colorPicker : undefined), animationSpeed = colorPicker ? colorPicker.color.options.animationSpeed : 0, isColorPicker = $(e.target).closest('.cp-app')[0], inputIndex = $(that).index(e.target);
            ...
            }, that = this, colorPickers = this.colorPickers || [], testColors = new window.Colors({customBG: config.customBG, allMixDetails: true});
    ...
    $.docCookies = function (key, val, options) {
        var encode = encodeURIComponent, decode = decodeURIComponent, cookies, n, tmp, cache = {}, days;
        if (val === undefined) {
            ...
            if (!key)return cache; else return cache[key];
        } else {
            options = options || {};
