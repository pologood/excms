...
Actions.prototype.init = function()
{
	...
	this.addAction('import', function()
	{
		...
		{
			mxLog.debug('window.openFile.setConsumer >>> ');
			try
			{
				//console.log('xml >>>');
				//console.log(xml);	
				...
				//console.log('doc : mxUtils.parseXml(xml) >>>');
				//console.log(doc);	
				//console.log('=========================');
				...
				//console.log('model : new mxGraphModel() >>>');
				//console.log(model);
				//console.log('=========================');
				
				//var dec = new mxCodec(doc);
				//console.log('dec : new mxCodec(doc) >>>');
				//console.log(dec);
				//console.log('=========================');
				...
				//dec.decode(doc, model);
				//dec.decode(doc.documentElement, model);
				//console.log('dec.decode(doc.documentElement, model) >>>');
				//console.log('dec >>>');
				//console.log(dec);
				//console.log('model >>>');
				//console.log(model);
				...
				var curXml = mxUtils.getXml(editor.getGraphXml());
				//console.log('curXml : editor.getGraphXml() >>>');
				//console.log(curXml);
				//console.log('=========================');

				/*var dec1 = new mxCodec(doc.documentElement.ownerDocument);
				console.log('dec1 : new mxCodec(doc.documentElement.ownerDocument) >>>');
				console.log(dec1);
				console.log('=========================');
				dec1.decode(doc.documentElement, model);
				console.log('dec1.decode(doc.documentElement, model) >>>');
				console.log('dec1 >>>');
				console.log(dec1);
				console.log('model >>>');
				console.log(model);
				...
				console.log('editor.graph.getModel() >>>');
				console.log(editor.graph.getModel());
				console.log('=========================');
				dec1.decode(doc.documentElement, editor.graph.getModel());
				console.log('dec1.decode(doc.documentElement, editor.graph.getModel())>>>');
				console.log('dec1 >>>');
				console.log(dec1);
				console.log('editor.graph.getModel() >>>');
				console.log(editor.graph.getModel());
...
*/
	...
	this.addAction('save', function() {
		...
		mxLog.info('action-save click >>>');
		ui.saveFile(false); 

	}, null, null, 'Ctrl+S');
	this.addAction('saveAs', function() { ui.saveFile(true); }, null, null, 'Ctrl+Shift-S');
	this.addAction('export', function() {
		 ui.showDialog(new ExportDialog(ui).container, 300, 200, true, true); }, null, null, 'Ctrl+E');
	...
	this.addAction('delete', function() { 
		//mxLog.info('delete event >>>');
//		console.log('toorbar delete event >>>');
