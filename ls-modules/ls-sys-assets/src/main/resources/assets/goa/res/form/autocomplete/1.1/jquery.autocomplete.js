...
$.Autocompleter.defaults = {
	...
	matchSubset: true,  // 是否使用缓存匹配
	matchContains: false, // 是否匹配包含
	cacheLength: 10,
	max: 100,
	mustMatch: false, // 必须匹配
	extraParams: {},
	selectFirst: true,
...
$.Autocompleter.Cache = function(options) {
	...
	function matchSubset(s, sub) {
		//Ls.log.add('matchSubset >>>> s = '+s+' , sub = '+sub);
		if (!options.matchCase) 
			s = s.toLowerCase();
		var i = s.indexOf(sub);
		//var i = Ls.string.startWith(s,sub);
		...
		//if(!i)return false;
		//return i|| options.matchContains;
	};
