...
function dhtmlXLayoutObject(l, k, m) {
    if (window.dhtmlXContainer) {
        ...
        if ((l._isWindow == !0 || l._isCell) && !this.base) {
            if (l._isCell && l.attachLayout) return l.attachLayout(k, m);
            if (l.isWindow) return l.attachLayout(k, m);
            this.base = l
        }
        if (l == document.body && !this.base) document.body.style.overflow = "hidden";
        if ((typeof l == "object" || l == document.body) && !this.base) {
            var t = document.createElement("DIV");
            t.className = "dhxcont_global_layout_area";
            l.appendChild(t);
            l._isLayout = !0;
            this.cont = new dhtmlXContainer(l);
            ...
            l.adjustContent(l, this._mTop, null, null, this._mBottom);
            ...
            if (l == document.body) this._lw = this._tmTime = null,
			...
			if(_isIE){
				if(Ls && Ls.bindPageOnResizeEvent){
					Ls.bindPageOnResizeEvent(function(width,height){
						j._doOnResizeStart();						
					})					
				}
			}else{
				window.addEventListener("resize", j._doOnResizeStart, !1);
			}
        ...
        this._xmlParser = function() {
            ...
            d = this.getXMLTopNode("layout"), b = 0; b < d.childNodes.length; b++) {
                if (d.childNodes[b].tagName == "row") {
                    ...
                    for (var i = 0; i < e.childNodes.length; i++) if (e.childNodes[i].tagName == "cell") {
                        ...
                        if (h.getAttribute("obj") != null) {
                            for (var y = h.getAttribute("obj"), l = String(h.getAttribute("wh")).split(","), k = isNaN(l[0]), m = isNaN(l[0]) ? parseInt(j.polyObj[l[0]].style.width) : 0, n = 0; n < a.length; n++) for (var p = 0; p < a[n].length; p++) if (a[n][p] == y) {
                                if (!k) {
                                    for (var k = !0,
                                    G = j.base.offsetWidth - f[y][0] * j.skinParams[j.skin].ver_sep_width, w = 0; w < a[n].length; w++) isNaN(a[n][w]) || (G -= a[n][w], l[0] -= 1);
                                    m = Math.ceil(G / l[0])
                                }
                                a[n][p] = m
                            }
                            o.style.width = m + "px";
                            for (var k = isNaN(l[1]), t = isNaN(l[1]) ? parseInt(j.polyObj[l[1]].style.height) : 0, n = 0; n < c.length; n++) for (p = 0; p < c[n].length; p++) if (c[n][p] == y) {
                                if (!k) {
                                    for (var k = !0,
                                    v = j.base.offsetHeight - f[y][1] * j.skinParams[j.skin].hor_sep_height, w = 0; w < c.length; w++) isNaN(c[w][p]) || (v -= c[w][p], l[1] -= 1);
                                    t = Math.ceil(v / l[1])
                                }
                                c[n][p] = t
                            }
                ...
                if (d.childNodes[b].tagName == "table") {
                    ...
                    for (var A in f) {
                        k = !1;
                        for (n = 0; n < a.length; n++) for (p = 0; p < a[n].length; p++) if (a[n][p] == A && !k) {
                            for (var k = !0,
        ...
        this._buildSurface = function() {
            ...
            for (var e in this.polyObj) {
                ...
                if (this.skin == "dhx_terrace") this.polyObj[e]._setPadding(this.skinParams[this.skin].cell_pading_max, "dhxcont_layout_dhx_terrace"),
                this.polyObj[e].childNodes[0].style.borderRadius = "3px",
                this.polyObj[e].childNodes[0].childNodes[1].style.borderBottomLeftRadius = this.polyObj[e].childNodes[0].childNodes[1].style.borderBottomRightRadius = "3px";
        ...
        this._resizeVer = function(a) {
            ...
            if (! (this._resObj == null || this._anyExpL == null || this._anyExpR == null)) {
                ...
                if (this._effects.resize == !1) {
                    ...
                    var l = parseInt(g[0].style.width),
                    k = parseInt(i[0].style.width);
                    if (f < 0) {
                        var m = l + f;
                    ...
                    } else if (f > 0 && (r = k - f, r > i[0]._minW && r > this._minWRAlter)) {
                        m = l + k - r;
        ...
        this._resizeHor = function(a) {
            if (! (this._resObj == null || this._anyExpT == null || this._anyExpB == null)) {
                ...
                if (this._effects.resize == !1) {
                    ...
                    g = [], i = [], h = 0; h < d.length; h++) g[h] = this.polyObj[d[h]];
                    for (h = 0; h < b.length; h++) i[h] = this.polyObj[b[h]];
                    var l = parseInt(g[0].style.height),
                    k = parseInt(i[0].style.height);
                    if (f < 0) {
                        var m = l + f;
                    ...
                    } else if (f > 0 && (r = k - f, r > i[0]._minH + this._minHBAlter)) {
                        m = l + k - r;
        ...
        this._resizeStop = function() {
            ...
            if (this._resObj != null) if (this._effects.resize == !1) {
                ...
                var k = [];
                if (this._resObj._left != null) for (var m = 0; m < this._resObj._left.length; m++) k[k.length] = this._resObj._left[m];
                if (this._resObj._right != null) for (m = 0; m < this._resObj._right.length; m++) k[k.length] = this._resObj._right[m];
                if (this._resObj._top != null) for (m = 0; m < this._resObj._top.length; m++) k[k.length] = this._resObj._top[m];
                if (this._resObj._bottom != null) for (m = 0; m < this._resObj._bottom.length; m++) k[k.length] = this._resObj._bottom[m];
                this._resObj = this._resFunc = null;
                this._hideCovers();
                for (var s = [], m = 0; m < k.length; m++) if (typeof k[m] == "object") for (var n = 0; n < k[m].length; n++) s[s.length] = this.polyObj[k[m][n]];
                else s[s.length] = this.polyObj[k[m]];
        ...
        this.setSizes = function(a) {
            ...
            if (this.base.offsetParent) {
				...
				//alert('width='+this.base.style.width + ',height='+this.base.style.height);
                var b = {},
                e;
...
dhtmlXLayoutObject.prototype.unload = function() {
    ...
    for (var l in this.polyObj) {
        var k = this.polyObj[l];
        k._isCell = null;
        k.skin = null;
        k.getId = null;
        k.getIndex = null;
        ...
        k._savedW = null;
        k.ondblclick = null;
        var m = k.childNodes[0].childNodes[0];
        m.className = "";
        m._dockCell = null;
        m._resize = null;
        m._h = null;
    ...
    for (l in this.polyObj) this.polyObj[l] = null;
    ...
    this.tpl = null;
    for (l in this.sepHor) this.sepHor[l] = null;
    for (l in this.sepVer) this.sepVer[l] = null;
...
dhtmlXLayoutObject.prototype.setCollapsedText = function(l, k) {
    if (this.polyObj[l]) {
        var m = this.polyObj[l].childNodes[0].childNodes[0];
        if (m.childNodes[m.childNodes.length - 1]._ct === !0) var j = m.childNodes[m.childNodes.length - 1];
        else j = document.createElement("DIV"),
        j._ct = !0,
        j.className = "dhtmlxInfoBarLabel_collapsed_" + this.polyObj[l]._resize,
        m.appendChild(j);
        j.innerHTML = k;
        this._fixCollapsedText();
        m = null
...
dhtmlXLayoutObject.prototype._fixCollapsedText = function() {
    for (var l in this.polyObj) if (this.polyObj[l]._resize == "hor") {
        var k = this.polyObj[l].childNodes[0].childNodes[0];
        if (k.childNodes[k.childNodes.length - 1]._ct === !0 && (k.childNodes[k.childNodes.length - 1].style.width = Math.max(0, k.offsetHeight - k.childNodes[4].offsetTop - k.childNodes[4].offsetHeight - 12) + "px", _isFF || _isOpera || _isChrome)) k.childNodes[k.childNodes.length - 1].style.bottom = "-12px"
    }
};
dhtmlXLayoutObject.prototype.i18n = {
    ...
    dhtmlx.extend_api("dhtmlXLayoutObject", {
        _init: function(l) {
            return [l.parent, l.pattern, l.skin]
        },
    ...
    },
    {
        ...
        _autosize: function(l) {
            this.setAutoSize(l[0], l[1])
        },
        _effect: function(l) {
            l.collapse && this.setEffect("collapse", l.collapse);
            l.resize && this.setEffect("resize", l.resize);
            l.highlight && this.setEffect("highlight", l.highlight)
        }
    })
})();
dhtmlXLayoutObject.prototype.attachHeader = function(l) {
    if (!this._ha) {
        typeof l != "object" && (l = document.getElementById(l));
        var k = l.offsetHeight + (this.skin == "dhx_web" ? 9 : 2) + 2;
        this.cont.obj._offsetTop = k;
        ...
        this._ha.style.height = l.offsetHeight + "px";
        document.body.appendChild(this._ha);
        this._ha.appendChild(l);
...
dhtmlXLayoutObject.prototype.attachFooter = function(l) {
    if (!this._fa) {
        typeof l != "object" && (l = document.getElementById(l));
        var k = l.offsetHeight + (this.skin == "dhx_web" ? 9 : 2) - 2;
        this.cont.obj._offsetHeight -= k;
        ...
        this._fa.style.height = l.offsetHeight + "px";
        document.body.appendChild(this._fa);
        this._fa.appendChild(l);
...
dhtmlXLayoutObject.prototype._fixToolbars = function() {
    if (_isIE) for (var l in this.polyObj) this.polyObj[l].vs[this.polyObj[l].av].toolbar != null && this.polyObj[l].vs[this.polyObj[l].av].toolbar._fixSpacer()
};
dhtmlXLayoutObject.prototype._hideBorders = function() {
    if (this.skin == "dhx_terrace") {
        ...
        for (var l in this.polyObj) this.polyObj[l]._setPadding(this.skinParams[this.skin].cell_pading_max, "dhxcont_layout_" + this.skin),
        this.polyObj[l].adjustContent(this.polyObj[l].childNodes[0], this.skinParams[this.skin].cpanel_height)
    }
};
