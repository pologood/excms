...
{
	this.addItems(['save','import','export','-'])
...
*/
    ...
    this.addEdgeSelectionHandler([line]);
	...
	if (funct != null)
	{
		...
		mxEvent.addListener(elt, 'click', mxUtils.bind(this, function(evt)
		{
			if (elt.enabled == null || elt.enabled)
			{
				...
				menu.popup(elt.offsetLeft, elt.offsetTop + elt.offsetHeight + 4 , null, evt);
