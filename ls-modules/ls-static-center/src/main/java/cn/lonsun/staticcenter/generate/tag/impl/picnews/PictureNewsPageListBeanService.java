...
@Component
public class PictureNewsPageListBeanService extends ArticleNewsPageListBeanService {
    ...
    public Object getObject(JSONObject paramObj) {
        ...
        Long[] columnIds = super.getQueryColumnIdByChild(paramObj, BaseContentEO.TypeCode.articleNews.toString());
        ...
        return this.baseContentDao.getPagination(pageIndex, pageSize, hql.toString(), paramMap);
    }
