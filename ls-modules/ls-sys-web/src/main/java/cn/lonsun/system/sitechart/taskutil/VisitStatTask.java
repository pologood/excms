//package cn.lonsun.system.sitechart.taskutil;
//
...
//
//@Component
//public class VisitStatTask {
//	private static final Logger logger = LoggerFactory.getLogger(VisitStatTask.class);
//	
//	private ISiteChartMainService siteChartMainService = SpringContextHolder.getBean("siteChartMainService");
//
//	private ISiteChartTrendService siteChartTrendService = SpringContextHolder.getBean("siteChartTrendService");
//
//	@Scheduled(cron = "0 0 0-23 * * ?")
//	// @Scheduled(cron="0/10 * * * * ?")
//	public void pvTrendTask() {
