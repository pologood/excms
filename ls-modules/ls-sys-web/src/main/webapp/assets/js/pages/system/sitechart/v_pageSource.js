var v_ps = function () {
    ...
    function getData(cur) {
        return Ls.ajaxGet({
            url: "/visitSource/getPageSourceDetail",
            data: cur
        }).done(function (d) {
    ...
    var visit_detail_template = Ls.compile(
        ...
        '<thead>' +
        '<tr>' +
        '  <th style="width:60%;"><div style="margin-left:25px">来路页面</div></th>' +
        '  <th style="width:10%;" align="right"><div style="text-align:right">浏览次数(PV)<div></th>' +
        '  <th style="width:10%;" align="left"><span class="spl"> | </span>占比</th>' +
        '  <th style="width:10%;"><div style="text-align:right">访问次数(SV)<div></th> ' +
        '  <th style="width:10%;" align="left"><span class="spl"> | </span>占比</th>' +
        '</tr>' +
        '</thead>' +
        '<tbody>' +
