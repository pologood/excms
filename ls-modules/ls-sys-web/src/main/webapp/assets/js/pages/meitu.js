...
xiuxiu.lightEditor = xiuxiu.lightEditor || {
    url: "http://open.web.meitu.com/sources/light/PhotoEditor.swf?s=" + Math.random() + "&version=201410201425",
...
xiuxiu.lightPuzzle = xiuxiu.lightPuzzle || {
    url: "http://open.web.meitu.com/sources/puzzle/CollagePlugin.swf?s=" + Math.random() + "&version=201305211645",
...
xiuxiu.richEditor = xiuxiu.richEditor || {
    url: "http://xiuxiu.web.meitu.com/Main.swf?s=" + Math.random() + "&v=2.6.106",
...
xiuxiu.daitoutie = xiuxiu.daitoutie || {
    url: "http://open.web.meitu.com/sources/daitoutie/FacePhoto.swf?s=" + Math.random() + "&version=201304251419",
...
xiuxiu.avatarEditor = xiuxiu.avatarEditor || {
    url: "http://open.web.meitu.com/sources/avatar/avatar.swf?s=" + Math.random() + "&version=201410201414",
...
xiuxiu.batchEditor = xiuxiu.batchEditor || {
    url: "http://xiuxiu.web.meitu.com/plugin/batch/plugin.swf?s=" + Math.random() + "&version=201405281142",
