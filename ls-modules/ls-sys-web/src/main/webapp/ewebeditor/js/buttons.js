...
var Buttons = {
    ...
    "TextIndent": [139, "", "Btn", 0],
    "LineHeightMenu": [140, "EWEBMenu.ShowToolMenu(event,'lineheight')", "Btn", 0],
    "MarginBottomMenu": [141, "EWEBMenu.ShowToolMenu(event,'marginbottom')", "Btn", 0],
    "MarginTopMenu": [142, "EWEBMenu.ShowToolMenu(event,'margintop')", "Btn", 0],
    "ImageMargin": [145, "", "Btn", 0],
    ...
    "MyZoom": ["zoom.png", "DoMyFunction()", "Btn", 0],
    "MyPic": ["meitu.png", "getPic(event)", "Btn", 0],
    "MyVideo": ["video.png", "getVideo(event)", "Btn", 0],
    "Myfile": ["Myfile.png", "getFile(event)", "Btn", 0]
