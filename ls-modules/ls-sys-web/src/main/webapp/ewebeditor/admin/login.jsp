...
<TABLE cellSpacing=0 cellPadding=0 width=732 align=center border=0>
    ...
    <TR>
        ...
        <TD colSpan=2>&nbsp;</TD>
        <TD><IMG height=110 alt="" src="images/spacer.gif" width=1></TD>
    </TR>
    <TR>
            ...
            <TABLE cellSpacing=0 cellPadding=3 width="50%" border=0>
                <FORM name=loginform action="?action=login" method=post>
                    ...
                    <TR>
                        ...
                        <TD width="76%"><INPUT class=input size=16 name=usr></TD>
                    </TR>
                    <TR>
                        <TD class=c92 width="24%">密　码</TD>
                        <TD width="76%"><INPUT class=input type=password size=16 name=pwd></TD>
                    </TR>
                    <TR>
                        <TD width="24%">&nbsp;</TD>
                        <TD width="76%">
        ...
        <TD><IMG height=93 alt="" src="images/spacer.gif" width=1></TD>
    </TR>
    <TR>
        <TD width=254 background=images/1_13.gif colSpan=2 height=161>
        ...
        <TD><IMG height=161 alt="" src="images/spacer.gif" width=1></TD>
    </TR>
    <TR>
        <TD colSpan=2 rowSpan=2><IMG height=81 alt="" src="images/spacer.gif" width=254></TD>
        <TD><IMG height=51 alt="" src="images/spacer.gif" width=1></TD>
    </TR>
    <TR>
