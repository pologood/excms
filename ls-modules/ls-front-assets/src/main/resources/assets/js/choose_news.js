...
var ztree_settings_ex8 = {
    ...
    var getNews = function () {
        ...
        var getData = function () {
            return Ls.ajax({
                type:'get',
                url: "/search/getNewColumn?siteId="+currContext.siteId,
                success: function (json) {
                    ...
                    currContext.newsTreeztree = $.fn.zTree.init($("#new_tree"), settings, data);
                    currContext.newsTreeztree.expandAll(false);
