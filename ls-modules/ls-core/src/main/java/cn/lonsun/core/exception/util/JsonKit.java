package cn.lonsun.core.exception.util;
...
public class JsonKit {
	...
	public static String mapToJson(Map<String,Object> map, int depth) {
		if(map == null)
			return "null";
	...
	public static String listToJson(List<Object> list, int depth) {
		if(list == null)
			return "null";
