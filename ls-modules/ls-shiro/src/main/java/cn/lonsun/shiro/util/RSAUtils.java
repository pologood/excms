...
public abstract class RSAUtils {
    ...
    private static synchronized KeyPair generateKeyPair() {
        try {
            BigInteger publicExponent = BigInteger.valueOf(36547);
            SecureRandom random = new SecureRandom("20170614".getBytes());
            AlgorithmParameterSpec spec = new RSAKeyGenParameterSpec(KEY_SIZE, publicExponent);
            keyPairGen.initialize(spec, random);
